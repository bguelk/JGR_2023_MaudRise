...
if __name__ == '__main__':
    ...
    for year in range(years,yeare):
        ...
        dT_eddy_l1_tc=dT_eddy_l1_tc.assign_attrs(long_name='eddy advective heat fluxes in Taylor Cap- level 1')
        ...
        eddy_hf_up_200_tc=eddy_hf_up_200_tc.assign_attrs(long_name='vertical eddy heat fluxes in Taylor Cap at 200m')
        ...
        dT_eddy_l2_tc=dT_eddy_l2_tc.assign_attrs(long_name='advective eddy heat fluxes in Taylor Cap- level 2')
        ...
        eddy_hf_up_1000_tc=eddy_hf_up_1000_tc.assign_attrs(long_name='vertical eddy heat fluxes in Taylor Cap at 1000m')
        ...
        dT_eddy_l3_tc=dT_eddy_l3_tc.assign_attrs(long_name='advective eddy heat fluxes in Taylor Cap- level 3')
