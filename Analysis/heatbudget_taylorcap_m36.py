...
mask=xr.open_dataset('./post_pro_check/mask_tc_m36.nc')
...
if __name__ == '__main__':
    ...
    for year in range(years,yeare):
        ...
        print('compute the heat content and fluxes for the full depth of the Taylor Cap')
        ...
        dT_tc=dT_tc.assign_attrs(long_name='advective heat fluxes in Taylor Cap- full depth')
        dT_tc.to_netcdf(Path(path_out)/f'dT_tc_{year}_m36.nc')

        dh_tc =dh_tc.rename("dh_tc")
        dh_tc =dh_tc.assign_attrs(long_name=' change in Heat content in the Taylor Cap- full depth')
        ...
        dT_l1_tc=dT_l1_tc.assign_attrs(long_name='advective heat fluxes in Taylor Cap- level 1')
        dT_l1_tc.to_netcdf(Path(path_out)/f'dT_l1_tc_{year}_m36.nc')

        dh_l1_tc =dh_l1_tc.rename("dh_l1_tc")
        dh_l1_tc =dh_l1_tc.assign_attrs(long_name=' change in Heat content in the Taylor Cap- level 1')
        dh_l1_tc.to_netcdf(Path(path_out)/f'dh_dt_l1_tc_{year}_m36.nc')

        hf_up_200_tc=hf_up_200_tc.rename("hf_up_200_tc")
        hf_up_200_tc=hf_up_200_tc.assign_attrs(long_name='vertical heat fluxes in Taylor Cap at 200m')
        ...
        dT_l2_tc=dT_l2_tc.assign_attrs(long_name='advective heat fluxes in Taylor Cap- level 2')
        dT_l2_tc.to_netcdf(Path(path_out)/f'dT_l2_tc_{year}_m36.nc')

        dh_l2_tc =dh_l2_tc.rename("dh_l2_tc")
        dh_l2_tc =dh_l2_tc.assign_attrs(long_name=' change in Heat content in the Taylor Cap- level 2')
        dh_l2_tc.to_netcdf(Path(path_out)/f'dh_dt_l2_tc_{year}_m36.nc')

        hf_up_1000_tc=hf_up_1000_tc.rename("hf_up_1000_tc")
        hf_up_1000_tc=hf_up_1000_tc.assign_attrs(long_name='vertical heat fluxes in Taylor Cap at 1000m')
        ...
        dT_l3_tc=dT_l3_tc.assign_attrs(long_name='advective heat fluxes in Taylor Cap- level 3')
        dT_l3_tc.to_netcdf(Path(path_out)/f'dT_l3_tc_{year}_m36.nc')

        dh_l3_tc =dh_l3_tc.rename("dh_l3_tc")
        dh_l3_tc =dh_l3_tc.assign_attrs(long_name=' change in Heat content in the Taylor Cap- level 3')
